...
# Gamma perturbation 
#================================
class Gamma_Perturbation(Systematics):
    def __init__(self, systematics):
        ...
        self.delta_k_1 = systematics("delta_k_1")
        self.delta_tau_1 = systematics("delta_tau_1")
        self.delta_k_2 = systematics("delta_k_2")
        self.delta_tau_2 = systematics("delta_tau_2")
