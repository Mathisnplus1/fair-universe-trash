...
# Internal Imports
#================================
from Data_Generator.distributions import Gaussian, Gamma, Gaussian_Gamma
from Data_Generator.systematics import Translation,Scaling,Gamma_Perturbation
from Data_Generator.logger import Logger
from Data_Generator.checker import Checker
...
class DataGenerator:
    ...
    def load_settings(self):
        ...
        #-----------------------------------------------
        # Be careful ! We assume both theta and alpha to be given in radians, not degrees. So, no conversion to gradians is needed.
        ...
        if self.data_mode == DISTRIBUTION_GAUSSIAN :
            ...
            # The two following parameter are irrelevant and will be removed soon
            theta = self.settings["theta"]
            L = self.settings["L"]
        ...
        if self.bias_mode == SYSTEMATIC_TRANSLATION :
            ...
            # Background biased points
            biased_background_dim_1 = [background_dim_1[0],[background_dim_1[1][0]+delta_k_1,background_dim_1[1][1]+delta_tau_1]]
            biased_background_dim_2 = [background_dim_2[0],[background_dim_2[1][0]+delta_k_2,background_dim_2[1][1]+delta_tau_2]]
            ...
            # Signal biased points
            biased_signal_dim_1 = [signal_dim_1[0],[signal_dim_1[1][0]+delta_k_1,signal_dim_1[1][1]+delta_tau_1]]
            biased_signal_dim_2 = [signal_dim_2[0],[signal_dim_2[1][0]+delta_k_2,signal_dim_2[1][1]+delta_tau_2]]
