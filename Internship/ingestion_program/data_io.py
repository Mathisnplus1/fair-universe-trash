...
def load_data (data_dir, load_settings=False) :
    ...
    for i in range(0,total_files):
        ...
        train_data_file = "train_"+str(i)+".csv"
        test_data_file = "test_"+str(i)+".csv"
        train_labels_file = "train_"+str(i)+".labels"
        test_labels_file = "test_"+str(i)+".labels"
        settings_file = "settings_"+str(i)+".json"
